...
Companies with money for lawyers can try to enforce licenses by suing other companies who have violated the licenses. Community projects usually don't have the resources to do that. Instead, they may choose a license to express and implement their goals, and they may try to [build social and cultural norms in the community](https://lu.is/blog/2016/09/26/public-licenses-and-data-so-what-to-do-instead/) to encourage people to respect the license.
